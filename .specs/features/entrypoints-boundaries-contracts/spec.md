...
| --- | --- | --- | --- |
| EBC-01 | P1: Project-as-component promotion | Phase 2 (T6, T8) | In Tasks |
| EBC-02 | P1: Project-as-component promotion | Phase 2 (T6, T8) | In Tasks |
| EBC-03 | P1: Project-as-component promotion | Phase 2 (T6) | In Tasks |
| EBC-04 | P1: Project-as-component promotion | Phase 2 (T6) | In Tasks |
| EBC-05 | P1: HTTP entry point classification | Phase 2 (T7, T8) | In Tasks |
...
| EBC-08 | P1: HTTP entry point classification | Phase 2 (T7) | In Tasks |
| EBC-09 | P1: HTTP entry point classification | Phase 2 (T7) | In Tasks |
| EBC-10 | P1: Outbound HTTP boundary classification | Phase 3 (T10) | In Tasks |
| EBC-11 | P1: Outbound HTTP boundary classification | Phase 3 (T10) | In Tasks |
| EBC-12 | P1: Outbound HTTP boundary classification | Phase 3 (T10) | In Tasks |
| EBC-13 | P1: Outbound HTTP boundary classification | Phase 3 (T10) | In Tasks |
| EBC-14 | P1: Outbound HTTP boundary classification | Phase 4 (T14) | In Tasks |
| EBC-15 | P1: Outbound HTTP boundary classification | Phase 3 (T10) | In Tasks |
| EBC-16 | P1: Outbound HTTP boundary classification | Phase 3 (T10) | In Tasks |
| EBC-17 | P1: Messaging boundary classification | Phase 3 (T11) | In Tasks |
| EBC-18 | P1: Messaging boundary classification | Phase 3 (T12) | In Tasks |
| EBC-19 | P1: Messaging boundary classification | Phase 2 (T7) | In Tasks |
...
| EBC-27 | P1: Composable classification stage | Phase 1 (T2, T4, T5), Phase 5 (T20) | In Tasks |
| EBC-28 | P1: Composable classification stage | Phase 1 (T3), Phase 5 (T20) | In Tasks |
