...
| --- | --- | --- | --- |
| STOR-01 | P1: Versioned wire contracts for every Domain family | Tasks | In Tasks |
| STOR-02 | P1: Versioned wire contracts for every Domain family | Tasks | In Tasks |
| STOR-03 | P1: Versioned wire contracts for every Domain family | Tasks | In Tasks |
| STOR-04 | P1: Versioned wire contracts for every Domain family | Tasks | In Tasks |
| STOR-05 | P1: Versioned wire contracts for every Domain family | Tasks | In Tasks |
| STOR-06 | P1: Versioned wire contracts for every Domain family | Tasks | In Tasks |
| STOR-07 | P1: Versioned wire contracts for every Domain family | Tasks | In Tasks |
| STOR-08 | P1: Versioned wire contracts for every Domain family | Tasks | In Tasks |
| STOR-09 | P1: Versioned wire contracts for every Domain family | Tasks | In Tasks |
...
| STOR-32 | P1: Commit-time structural gates | Tasks | In Tasks |
| STOR-33 | P1: Commit-time structural gates | Tasks | In Tasks |
| STOR-34 | P1: Factual package reader | Tasks | In Tasks |
| STOR-35 | P1: Factual package reader | Tasks | In Tasks |
...
| STOR-44 | P1: Compact payload layout | Tasks | In Tasks |
...
| STOR-59 | P1: Session isolation and cleanup | Tasks | In Tasks |
| STOR-60 | P1: Session isolation and cleanup | Tasks | In Tasks |
| STOR-61 | P1: Session isolation and cleanup | Tasks | In Tasks |
