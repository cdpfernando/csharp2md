...
| ENG-02 | P1: Target assembly topology with enforced boundaries | Tasks | Verified |
...
| ENG-14 | P1: One analysis facade over an eight-stage pipeline | Tasks | Verified |
| ENG-15 | P1: One analysis facade over an eight-stage pipeline | Tasks | Verified |
| ENG-16 | P1: One analysis facade over an eight-stage pipeline | Tasks | Verified |
...
| ENG-22 | P1: Transactional storage port with atomic publication | Tasks | Verified |
...
| ENG-26 | P1: Transactional storage port with atomic publication | Tasks | Verified |
...
| ENG-32 | P1: Multi-solution isolation and determinism | Tasks | Verified |
| ENG-33 | P1: Multi-solution isolation and determinism | Tasks | Verified |
...
| ENG-39 | P1: Provisional analyze CLI | Tasks | Verified |
| ENG-40 | P1: Provisional analyze CLI | Tasks | Verified |
| ENG-41 | P1: Provisional analyze CLI | Tasks | Verified |
| ENG-42 | P1: Provisional analyze CLI | Tasks | Verified |
| ENG-43 | P1: Provisional analyze CLI | Tasks | Verified |
...
| ENG-54 | P1: Legacy excision with a port ledger | Tasks | Verified |
