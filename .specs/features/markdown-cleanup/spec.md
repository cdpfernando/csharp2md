...
| MDCLN-11 | P1 | Execute | Verified — independent Verifier PASS on round 2 (`.specs/features/markdown-cleanup/validation.md`), all 3 sub-clauses evidenced and sensor-confirmed |
