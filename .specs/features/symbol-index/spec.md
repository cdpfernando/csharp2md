...
| --- | --- | --- | --- |
| SYMIDX-01 | P1 (one entry per symbol) | Design | Pending |
...
| SYMIDX-06 | P1 (original spelling preserved) | Design | Pending |
| SYMIDX-07 | P1 (FindMembers) | Design | Pending |
| SYMIDX-08 | P1 (predefined-type + global:: normalization) | Design | Implementing |
| SYMIDX-09 | P1 (syntax-only indexing, never fabricated Exact) | Design | Pending |
| SYMIDX-10 | P1 (Name/Namespace/ContainingType from syntax alone) | Design | Pending |
| SYMIDX-11 | P1 (empty solution) | Design | Pending |
| SYMIDX-12 | P1 (no simple-name-only merging) | Design | Pending |
