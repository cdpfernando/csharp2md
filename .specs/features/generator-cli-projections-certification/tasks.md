...
- [ ] Every planned artifact is asserted written exactly once, and nothing outside the plan is written
- [ ] Manifest-last publication order is asserted preserved
- [ ] An abort is asserted to leave the prior package byte-identical
- [ ] Gate check passes: `dotnet test tests/Csharp2Md.Storage.Tests/Csharp2Md.Storage.Tests.csproj && dotnet test tests/Csharp2Md.Projection.Tests/Csharp2Md.Projection.Tests.csproj`
- [ ] Test count reported; total ≥ previous task's total
...
- [ ] For every manifest entry, the cited artifact is opened and its real entry count and byte size are asserted equal to the manifest's values
- [ ] A projection artifact holding records is asserted to carry a non-zero count
- [ ] Gate check passes: `dotnet test tests/Csharp2Md.Storage.Tests/Csharp2Md.Storage.Tests.csproj && dotnet test tests/Csharp2Md.Projection.Tests/Csharp2Md.Projection.Tests.csproj`
- [ ] Test count reported; total ≥ previous task's total
