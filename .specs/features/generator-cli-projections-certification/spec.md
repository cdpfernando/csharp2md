...
| GCPC-042 | P1: Bounded payloads | RP-53 and RP-54 | Design | Pending |
| GCPC-043 | P1: Bounded payloads | output-and-retrieval.md scale constraints | Design | Pending |
| GCPC-044 | P1: Bounded payloads | Audit inventory: contains, belongs-to, invocation | Design | Pending |
| GCPC-045 | P1: Bounded payloads | quality-and-security.md performance | Design | Pending |
| GCPC-046 | P1: Retrieval guide | Audit B5 | Design | Pending |
| GCPC-047 | P1: Retrieval guide | Audit B4 and B5 | Design | Pending |
| GCPC-048 | P1: Retrieval guide | Audit B5; output-and-retrieval.md scenarios | Design | Pending |
| GCPC-049 | P1: Retrieval guide | Audit B5; AD-010 | Design | Pending |
| GCPC-050 | P1: Retrieval guide | Audit B4 | Design | Pending |
| GCPC-051 | P1: Retrieval guide | output-and-retrieval.md scenario 7 | Design | Pending |
...
| GCPC-055 | P1: Retrieval guide | RP-42 extended to the guide | Design | Pending |
| GCPC-056 | P1: Provenance | Audit scope note and gate 8 | Design | Pending |
| GCPC-057 | P1: Provenance | taxonomy.md version axes | Design | Pending |
...
| GCPC-071 | P1: CLI surface | quality-and-security.md corruption path | Design | Pending |
| GCPC-072 | P1: CLI surface | MSC-09 and MSC-15 | Design | Pending |
| GCPC-073 | P1: CLI surface | Existing CLI contract | Design | Pending |
...
| GCPC-080 | P1: Engine certification | AD-009 | Design | Pending |
...
| GCPC-099 | P2: HTTP verb and route | Audit I3; extends EBC-06 | Design | Pending |
...
| GCPC-115 | P1: Completion gate | Audit readiness matrix | Design | Pending |
| GCPC-116 | P1: Completion gate | Audit verdict; D-01 | Design | Pending |
| GCPC-117 | P1: Completion gate | D-01 | Design | Pending |
