...
namespace SistemaE.Copia.Infraestrutura.Migrations;
...
partial class SistemaEDbContextModelSnapshot : ModelSnapshot
{
    protected override void BuildModel(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity("SistemaE.Copia.Nucleo.Venda", b =>
        {
            b.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("TEXT")
        ...
        modelBuilder.Entity("SistemaE.Copia.Nucleo.ItemVenda", b =>
        {
            b.Property<Guid>("Id")
                .ValueGeneratedOnAdd()
                .HasColumnType("TEXT")
        ...
        modelBuilder.Entity("SistemaE.Copia.Nucleo.ItemVenda", b =>
        {
            b.HasOne("SistemaE.Copia.Nucleo.Venda", null)
                .WithMany("Itens")
